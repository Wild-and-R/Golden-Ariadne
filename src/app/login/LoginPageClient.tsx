...
export default function LoginPageClient() {
  ...
  const handleAuth: SubmitEventHandler<HTMLFormElement> = async (e) => {
    ...
    // create profile in Supabase if signing up
  ...
  return (
    <div className="flex min-h-screen flex-col items-center justify-center bg-black px-4 py-12">
      ...
      >
        ...
        {/* Email Input */}
        <label htmlFor="email" className="mb-2 block font-semibold text-black">Email</label>
        <input
          id="email"
          type="email"
        ...
        {/* Password Input */}
        <label htmlFor="password" className="mb-2 block font-semibold text-black">Password</label>
        <input
          id="password"
          type="password"
          placeholder="••••••••"
        ...
        {isSignUp && (
          <>
            <label htmlFor="fullName" className="mb-2 block font-semibold text-black">Full Name</label>
            <input
              id="fullName"
              type="text"
